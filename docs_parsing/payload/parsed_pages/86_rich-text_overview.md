...
This documentation is about our new editor, based on Lexical (Meta's rich text editor). The previous default editor, based on Slate, has been deprecated and will be removed in 4.0. You can read [its documentation](../rich-text/slate), or the [migration guide](../rich-text/migration) to migrate from Slate to Lexical (recommended).
...
## [Extending the lexical editor with Features](/docs/rich-text/overview#extending-the-lexical-editor-with-features)
...
### [Features: The Building Blocks](/docs/rich-text/overview#features-the-building-blocks)
...
### [Integrating New Features](/docs/rich-text/overview#integrating-new-features)
...
## [Official Features](/docs/rich-text/overview#official-features)

You can find more information about the official features in our [official features docs](../rich-text/official-features).

## [Creating your own, custom Feature](/docs/rich-text/overview#creating-your-own-custom-feature)
...
## [TypeScript](/docs/rich-text/overview#typescript)
...
### [Automatic type generation](/docs/rich-text/overview#automatic-type-generation)
...
## [Admin customization](/docs/rich-text/overview#admin-customization)
...
### [Disable the gutter](/docs/rich-text/overview#disable-the-gutter)
...
### [Customize the placeholder](/docs/rich-text/overview#customize-the-placeholder)
...
## [Detecting empty editor state](/docs/rich-text/overview#detecting-empty-editor-state)
...
[Next Lexical Converters](/docs/rich-text/converters)
