...
## [Config Options](/docs/custom-components/document-views#config-options)

The following options are available:

Property |  Description   
---|---  
`root` |  The Root View overrides all other nested views and routes. No document controls or tabs are rendered when this key is set. More details.   
...
### [ Document Root](/docs/custom-components/document-views#document-root)

The Document Root is mounted on the top-level route for a Document. Setting this property will completely take over the entire Document View layout, including the title, Document Tabs, _and all other nested Document Views_ including the [Edit View](./edit-view), API View, etc.
...
### [Edit View](/docs/custom-components/document-views#edit-view)
...
## [Document Tabs](/docs/custom-components/document-views#document-tabs)
...
`Component` |  The component to render in the tab. This can be a Server or Client component. More details  
  
### [Tab Components](/docs/custom-components/document-views#tab-components)
...
#### [Server Component](/docs/custom-components/document-views#server-component)
```
...
#### [Client Component](/docs/custom-components/document-views#client-component)
```
'use client'
    import React from 'react'
...
[Next Edit View](/docs/custom-components/edit-view)
