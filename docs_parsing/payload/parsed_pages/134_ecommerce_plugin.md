<a id="page-134"></a>
---
url: https://payloadcms.com/docs/ecommerce/plugin
---

# Ecommerce Plugin

## [Basic Usage](/docs/ecommerce/plugin#basic-usage)
...
## [Options](/docs/ecommerce/plugin#options)

Option |  Type |  Description   
---|---|---  
`access` |  `object` |  Configuration to override the default access control, use this when checking for roles or multi tenancy. More  
`addresses` |  `object` |  Configuration for addresses collection and supported fields. More  
`carts` |  `object` |  Configuration for carts collection. More  
`currencies` |  `object` |  Supported currencies by the store. More  
`customers` |  `object` |  Used to provide the customers slug. More  
`inventory` |  `boolean` `object` |  Enable inventory tracking within Payload. Defaults to `true`. More  
`payments` |  `object` |  Configuring payments and supported payment methods. More  
`products` |  `object` |  Configuration for products, variants collections and more. More  
`orders` |  `object` |  Configuration for orders collection. More  
`transactions` |  `boolean` `object` |  Configuration for transactions collection. More  
...
## [Access](/docs/ecommerce/plugin#access)
...
### [adminOnlyFieldAccess](/docs/ecommerce/plugin#adminonlyfieldaccess)
...
### [adminOrPublishedStatus](/docs/ecommerce/plugin#adminorpublishedstatus)
...
### [isCustomer](/docs/ecommerce/plugin#iscustomer)
...
### [isAdmin](/docs/ecommerce/plugin#isadmin)
...
### [isAuthenticated](/docs/ecommerce/plugin#isauthenticated)
...
### [isDocumentOwner](/docs/ecommerce/plugin#isdocumentowner)
...
### [publicAccess](/docs/ecommerce/plugin#publicaccess)
...
## [Addresses](/docs/ecommerce/plugin#addresses)
...
### [supportedCountries](/docs/ecommerce/plugin#supportedcountries)
...
## [Carts](/docs/ecommerce/plugin#carts)
...
`cartItemMatcher` |  `CartItemMatcher` |  Custom function to determine item uniqueness when adding to cart. More  
...
### [Guest Carts](/docs/ecommerce/plugin#guest-carts)
...
### [Cart API Endpoints](/docs/ecommerce/plugin#cart-api-endpoints)
...
#### [Add Item](/docs/ecommerce/plugin#add-item)
...
#### [Update Item](/docs/ecommerce/plugin#update-item)
...
#### [Remove Item](/docs/ecommerce/plugin#remove-item)
...
#### [Clear Cart](/docs/ecommerce/plugin#clear-cart)
...
### [Cart Item Matcher](/docs/ecommerce/plugin#cart-item-matcher)
...
#### [Example: Fulfillment Options](/docs/ecommerce/plugin#example-fulfillment-options)
...
#### [Default Matcher](/docs/ecommerce/plugin#default-matcher)
...
### [Cart Operations (Server-side)](/docs/ecommerce/plugin#cart-operations-server-side)
...
## [Customers](/docs/ecommerce/plugin#customers)
...
## [Currencies](/docs/ecommerce/plugin#currencies)
...
Option |  Type |  Description   
---|---|---  
`supportedCurrencies` |  `Currency[]` |  An array of supported currencies by the store. Defaults to `USD`. See Currencies for available currencies.   
...
Note that adding new currencies here does not automatically enable them in your payment gateway. Make sure to enable the currencies in your payment gateway dashboard as well.

## [Inventory](/docs/ecommerce/plugin#inventory)
...
## [Payments](/docs/ecommerce/plugin#payments)

The `payments` option is used to configure payments and supported payment methods.

Option |  Type |  Description   
---|---|---  
`paymentMethods` |  `array` |  An array of payment method adapters. Currently, only Stripe is supported. More  
  
### [Payment adapters](/docs/ecommerce/plugin#payment-adapters)
...
#### [`groupOverrides`](/docs/ecommerce/plugin#groupoverrides)
...
### [Stripe Adapter](/docs/ecommerce/plugin#stripe-adapter)
...
Note that Payload will not install the Stripe SDK package for you automatically, so you will need to install it yourself:
```
pnpm add stripe
```
...
#### [Stripe `webhooks`](/docs/ecommerce/plugin#stripe-webhooks)
...
#### [Stripe client side](/docs/ecommerce/plugin#stripe-client-side)
...
## [Products](/docs/ecommerce/plugin#products)
...
`variants` |  `boolean` `object` |  Configuration for the variants collection. Defaults to true. More  
`validation` |  `ProductsValidation` |  Customise the validation used for checking products or variants before a transaction is created or a payment can be confirmed. More  
...
### [Variants](/docs/ecommerce/plugin#variants)
...
### [Products validation](/docs/ecommerce/plugin#products-validation)
...
## [Orders](/docs/ecommerce/plugin#orders)
...
## [Transactions](/docs/ecommerce/plugin#transactions)
...
## [Translations](/docs/ecommerce/plugin#translations)
...
### [Adding translations](/docs/ecommerce/plugin#adding-translations)
...
### [Overriding translations](/docs/ecommerce/plugin#overriding-translations)
...
[Next Ecommerce Frontend](/docs/ecommerce/frontend)
