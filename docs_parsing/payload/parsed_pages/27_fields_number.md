...
## [Config Options](/docs/fields/number#config-options)
...
## [ Admin Options](/docs/fields/number#admin-options)
...
## [Example](/docs/fields/number#example)
```
...
## [Custom Components](/docs/fields/number#custom-components)### [Field](/docs/fields/number#field)#### [Server Component](/docs/fields/number#server-component)
```
...
#### [Client Component](/docs/fields/number#client-component)
```
'use client'
...
### [Label](/docs/fields/number#label)#### [Server Component](/docs/fields/number#server-component)
```
import React from 'react'
...
[Next Point Field](/docs/fields/point)
