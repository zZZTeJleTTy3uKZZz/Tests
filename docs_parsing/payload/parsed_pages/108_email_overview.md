...
## [Introduction](/docs/email/overview#introduction)
...
## [Configuration](/docs/email/overview#configuration)### [Default Configuration](/docs/email/overview#default-configuration)
...
### [Email Adapter](/docs/email/overview#email-adapter)
...
### [Official Email Adapters](/docs/email/overview#official-email-adapters)
...
## [Nodemailer Configuration](/docs/email/overview#nodemailer-configuration)
...
## [Use SMTP](/docs/email/overview#use-smtp)
...
## [Resend Configuration](/docs/email/overview#resend-configuration)
...
## [Sending Mail](/docs/email/overview#sending-mail)
...
## [Sending email with attachments](/docs/email/overview#sending-email-with-attachments)
...
### [Resend adapter](/docs/email/overview#resend-adapter)
...
## [Attaching files from Payload media collections](/docs/email/overview#attaching-files-from-payload-media-collections)
...
### [With Resend adapter:](/docs/email/overview#with-resend-adapter)
```
const mediaDoc = await payload.findByID({
      collection: 'media',
      id: 'your-file-id',
...
## [Using multiple mail providers](/docs/email/overview#using-multiple-mail-providers)
...
[Next Jobs Queue](/docs/jobs-queue/overview)
