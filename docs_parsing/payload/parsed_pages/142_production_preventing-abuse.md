...
## [Introduction](/docs/production/preventing-abuse#introduction)

Payload has built-in security best practices that can be configured to your application-specific needs.

## [Limit Failed Login Attempts](/docs/production/preventing-abuse#limit-failed-login-attempts)
...
## [Max Depth](/docs/production/preventing-abuse#max-depth)
...
## [Cross-Site Request Forgery (CSRF)](/docs/production/preventing-abuse#cross-site-request-forgery-csrf)
...
## [Cross Origin Resource Sharing (CORS)](/docs/production/preventing-abuse#cross-origin-resource-sharing-cors)
...
## [Limiting GraphQL Complexity](/docs/production/preventing-abuse#limiting-graphql-complexity)
...
## [Malicious File Uploads](/docs/production/preventing-abuse#malicious-file-uploads)
...
[Next Performance](/docs/performance/overview)
