...
## [Access](/docs/authentication/operations#access)
...
## [Me](/docs/authentication/operations#me)
...
## [Login](/docs/authentication/operations#login)
...
**Server Functions:** Payload offers a ready-to-use `login` server function that utilizes the Local API. For integration details and examples, check out the [Server Function docs](../local-api/server-functions#reusable-payload-server-functions).

## [Logout](/docs/authentication/operations#logout)
...
**Server Functions:** Payload provides a ready-to-use `logout` server function that manages the user's cookie for a seamless logout. For integration details and examples, check out the [Server Function docs](../local-api/server-functions#reusable-payload-server-functions).

#### [Logging out with sessions enabled](/docs/authentication/operations#logging-out-with-sessions-enabled)
...
## [Refresh](/docs/authentication/operations#refresh)
...
**Server Functions:** Payload exports a ready-to-use `refresh` server function that automatically renews the user's token and updates the associated cookie. For integration details and examples, check out the [Server Function docs](../local-api/server-functions#reusable-payload-server-functions).

## [Verify by Email](/docs/authentication/operations#verify-by-email)
...
## [Unlock](/docs/authentication/operations#unlock)
...
## [Forgot Password](/docs/authentication/operations#forgot-password)
...
## [Reset Password](/docs/authentication/operations#reset-password)
...
[Next Authentication Emails](/docs/authentication/email)

#### Community Help Threads

  * [Authenticating an app in Payload Beta ](/community-help/discord/authenticating-an-app-in-payload-beta)
