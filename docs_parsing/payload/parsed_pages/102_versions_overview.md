...
![Versions](https://payloadcms.com/images/docs/versions-v3.jpg)
...
Versions are extremely performant and totally opt-in. They don't change the shape of your data at all. All versions are stored in a separate Collection and can be turned on and off easily at your risk.

## [Options](/docs/versions/overview#options)

Versions support a few different levels of functionality that each come with their own impacts to document workflow.

### [Versions enabled, drafts disabled](/docs/versions/overview#versions-enabled-drafts-disabled)
...
### [Versions and drafts enabled](/docs/versions/overview#versions-and-drafts-enabled)
...
### [Versions, drafts, and autosave enabled](/docs/versions/overview#versions-drafts-and-autosave-enabled)
...
## [Collection config](/docs/versions/overview#collection-config)
...
## [Global config](/docs/versions/overview#global-config)
...
### [Database impact](/docs/versions/overview#database-impact)
...
## [Version operations](/docs/versions/overview#version-operations)
...
### [ Find](/docs/versions/overview#find)
```
...
### [Find by ID](/docs/versions/overview#find-by-id)
```
...
### [Restore](/docs/versions/overview#restore)
```
...
## [Access Control](/docs/versions/overview#access-control)
...
[Next Drafts](/docs/versions/drafts)
