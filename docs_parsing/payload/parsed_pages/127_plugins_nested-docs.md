<a id="page-127"></a>
---
url: https://payloadcms.com/docs/plugins/nested-docs
---
...
## [Installation](/docs/plugins/nested-docs#installation)
...
## [Basic Usage](/docs/plugins/nested-docs#basic-usage)
...
### [Fields](/docs/plugins/nested-docs#fields)#### [Parent](/docs/plugins/nested-docs#parent)
...
#### [Breadcrumbs](/docs/plugins/nested-docs#breadcrumbs)
...
### [Options](/docs/plugins/nested-docs#options)#### [`collections`](/docs/plugins/nested-docs#collections)

An array of collections slugs to enable nested docs.

#### [`generateLabel`](/docs/plugins/nested-docs#generatelabel)

Each `breadcrumb` has a required `label` field. By default, its value will be set to the collection's `admin.useAsTitle` or fallback to the `ID` of the document.
...
#### [`generateURL`](/docs/plugins/nested-docs#generateurl)
...
#### [`parentFieldSlug`](/docs/plugins/nested-docs#parentfieldslug)
...
#### [`breadcrumbsFieldSlug`](/docs/plugins/nested-docs#breadcrumbsfieldslug)
...
## [Overrides](/docs/plugins/nested-docs#overrides)
...
## [Localization](/docs/plugins/nested-docs#localization)

This plugin supports localization by default. If the `localization` property is set in your Payload Config, the `breadcrumbs` field is automatically localized. For more details on how localization works in Payload, see the [Localization](../configuration/localization) docs.

## [TypeScript](/docs/plugins/nested-docs#typescript)
...
## [Examples](/docs/plugins/nested-docs#examples)
...
[Next Redirects Plugin](/docs/plugins/redirects)
