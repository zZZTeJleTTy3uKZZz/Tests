...
## [Config](/docs/fields/point#config)
...
## [ Example](/docs/fields/point#example)
```
...
## [Querying - near](/docs/fields/point#querying-near)
...
## [Querying - within](/docs/fields/point#querying-within)
...
## [Querying - intersects](/docs/fields/point#querying-intersects)
...
## [Custom Components](/docs/fields/point#custom-components)### [Field](/docs/fields/point#field)#### [Server Component](/docs/fields/point#server-component)
```
...
#### [Client Component](/docs/fields/point#client-component)
```
'use client'
...
### [Label](/docs/fields/point#label)#### [Server Component](/docs/fields/point#server-component)
```
import React from 'react'
...
[Next Radio Group Field](/docs/fields/radio)
