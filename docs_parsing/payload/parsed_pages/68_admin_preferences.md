...
Out of the box, Payload handles the persistence of your users' preferences in a handful of ways, including:
  ...
  2. The user's last active [Locale](../configuration/localization)
...
## [Use Cases](/docs/admin/preferences#use-cases)
...
## [Database](/docs/admin/preferences#database)
...
## [APIs](/docs/admin/preferences#apis)

Preferences are available to both [GraphQL](../graphql/overview#preferences) and [REST](../rest-api/overview#preferences) APIs.

## [Adding or reading Preferences in your own components](/docs/admin/preferences#adding-or-reading-preferences-in-your-own-components)
...
#### [`getPreference`](/docs/admin/preferences#getpreference)
...
#### [`setPreference`](/docs/admin/preferences#setpreference)
...
## [Example](/docs/admin/preferences#example)
...
[Next Page Metadata](/docs/admin/metadata)
