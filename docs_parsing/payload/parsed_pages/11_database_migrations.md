...
## [Migration file contents](/docs/database/migrations#migration-file-contents)
...
## [Using Transactions](/docs/database/migrations#using-transactions)

When migrations are run, each migration is performed in a new [transaction](../database/transactions) for you. All you need to do is pass the `req` object to any [Local API](../local-api/overview) or direct database calls, such as `payload.db.updateMany()`, to make database changes inside the transaction. Assuming no errors were thrown, the transaction is committed after your `up` or `down` function runs. If the migration errors at any point or fails to commit, it is caught and the transaction gets aborted. This way no change is made to the database if the migration fails.

### [Using database directly with the transaction](/docs/database/migrations#using-database-directly-with-the-transaction)
...
### [MongoDB:](/docs/database/migrations#mongodb)
```
...
### [Postgres:](/docs/database/migrations#postgres)
```
...
### [SQLite:](/docs/database/migrations#sqlite)
...
## [Migrations Directory](/docs/database/migrations#migrations-directory)
...
## [Commands](/docs/database/migrations#commands)### [Migrate](/docs/database/migrations#migrate)
...
### [Create](/docs/database/migrations#create)
...
### [Status](/docs/database/migrations#status)
...
### [Down](/docs/database/migrations#down)
...
### [Refresh](/docs/database/migrations#refresh)
...
### [Reset](/docs/database/migrations#reset)
...
### [Fresh](/docs/database/migrations#fresh)
...
## [When to run migrations](/docs/database/migrations#when-to-run-migrations)
...
#### [MongoDB](/docs/database/migrations#mongodb-migrations)
...
#### [Postgres](/docs/database/migrations#postgres-migrations)
...
## [Running migrations in production](/docs/database/migrations#running-migrations-in-production)
...
## [Environment-Specific Configurations and Migrations](/docs/database/migrations#environment-specific-configurations-and-migrations)
