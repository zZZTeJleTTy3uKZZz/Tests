...
## [How it works](/docs/admin/locked-documents#how-it-works)
...
### [Config Options](/docs/admin/locked-documents#config-options)
...
#### [Locking Options](/docs/admin/locked-documents#locking-options)
...
### [Impact on APIs](/docs/admin/locked-documents#impact-on-apis)
...
#### [Overriding Locks](/docs/admin/locked-documents#overriding-locks)
...
[Next Accessibility](/docs/admin/accessibility)
