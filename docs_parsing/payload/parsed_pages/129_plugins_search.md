<a id="page-129"></a>
---
url: https://payloadcms.com/docs/plugins/search
---
...
## [Installation](/docs/plugins/search#installation)
...
## [Basic Usage](/docs/plugins/search#basic-usage)
...
### [Options](/docs/plugins/search#options)#### [`collections`](/docs/plugins/search#collections)
...
#### [`localize`](/docs/plugins/search#localize)
...
#### [`defaultPriorities`](/docs/plugins/search#defaultpriorities)
...
#### [`searchOverrides`](/docs/plugins/search#searchoverrides)
...
#### [`beforeSync`](/docs/plugins/search#beforesync)
...
#### [`syncDrafts`](/docs/plugins/search#syncdrafts)
...
#### [`deleteDrafts`](/docs/plugins/search#deletedrafts)
...
#### [`skipSync`](/docs/plugins/search#skipsync)
...
#### [`reindexBatchSize`](/docs/plugins/search#reindexbatchsize)
...
### [Collection reindexing](/docs/plugins/search#collection-reindexing)
...
## [TypeScript](/docs/plugins/search#typescript)
...
[Next Sentry Plugin](/docs/plugins/sentry)

#### Related Guides

  * [Using Payload’s search plugin for custom search experiences ](/posts/guides/using-payloads-search-plugin-for-custom-search-experiences)
