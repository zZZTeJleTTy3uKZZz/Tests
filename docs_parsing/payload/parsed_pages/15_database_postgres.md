...
### [Usage](/docs/database/postgres#usage)
...
## [Access to Drizzle](/docs/database/postgres#access-to-drizzle)
...
## [Tables, relations, and enums](/docs/database/postgres#tables-relations-and-enums)
...
## [Prototyping in development mode](/docs/database/postgres#prototyping-in-development-mode)
...
## [Migration workflows](/docs/database/postgres#migration-workflows)
...
## [Drizzle schema hooks](/docs/database/postgres#drizzle-schema-hooks)### [beforeSchemaInit](/docs/database/postgres#beforeschemainit)
...
### [afterSchemaInit](/docs/database/postgres#afterschemainit)
...
### [Note for generated schema:](/docs/database/postgres#note-for-generated-schema)
...
[Next SQLite](/docs/database/sqlite)
