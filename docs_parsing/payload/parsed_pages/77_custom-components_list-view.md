...
## [Custom List View](/docs/custom-components/list-view#custom-list-view)
...
#### [Server Component](/docs/custom-components/list-view#server-component)
```
...
#### [Client Component](/docs/custom-components/list-view#client-component)
```
'use client'
    import React from 'react'
...
## [ Custom Components](/docs/custom-components/list-view#custom-components)
...
### [beforeList](/docs/custom-components/list-view#beforelist)
...
### [beforeListTable](/docs/custom-components/list-view#beforelisttable)
...
### [afterList](/docs/custom-components/list-view#afterlist)
...
### [afterListTable](/docs/custom-components/list-view#afterlisttable)
...
### [Description](/docs/custom-components/list-view#description)
...
[Next Authentication Overview](/docs/authentication/overview)
