...
## [Do I need a custom feature?](/docs/rich-text/custom-features#do-i-need-a-custom-feature)
...
## [Server Feature](/docs/rich-text/custom-features#server-feature)
...
### [i18n](/docs/rich-text/custom-features#i18n)
...
### [Markdown Transformers](/docs/rich-text/custom-features#server-feature-markdown-transformers)
...
### [Nodes](/docs/rich-text/custom-features#server-feature-nodes)
...
### [Feature load order](/docs/rich-text/custom-features#feature-load-order)
...
## [Client Feature](/docs/rich-text/custom-features#client-feature)
...
### [Adding a client feature to the server feature](/docs/rich-text/custom-features#adding-a-client-feature-to-the-server-feature)
...
### [Nodes](/docs/rich-text/custom-features#client-feature-nodes)
...
### [Plugins](/docs/rich-text/custom-features#plugins)
...
### [Toolbar groups](/docs/rich-text/custom-features#toolbar-groups)
...
#### [Custom buttons toolbar group](/docs/rich-text/custom-features#custom-buttons-toolbar-group)
...
#### [Custom dropdown toolbar group](/docs/rich-text/custom-features#custom-dropdown-toolbar-group)
...
### [Toolbar items](/docs/rich-text/custom-features#toolbar-items)
...
### [Slash Menu groups](/docs/rich-text/custom-features#slash-menu-groups)
...
### [Slash Menu items](/docs/rich-text/custom-features#slash-menu-items)
...
### [Markdown Transformers](/docs/rich-text/custom-features#client-feature-markdown-transformers)
...
### [Providers](/docs/rich-text/custom-features#providers)
...
## [Props](/docs/rich-text/custom-features#props)
...
### [Bringing props from the server to the client](/docs/rich-text/custom-features#bringing-props-from-the-server-to-the-client)
...
## [More information](/docs/rich-text/custom-features#more-information)
...
[Next Rendering On Demand](/docs/rich-text/rendering-on-demand)
