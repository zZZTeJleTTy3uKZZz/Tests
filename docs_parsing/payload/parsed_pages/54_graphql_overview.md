...
## [GraphQL Options](/docs/graphql/overview#graphql-options)
...
## [Collections](/docs/graphql/overview#collections)
...
## [Globals](/docs/graphql/overview#globals)
...
## [Preferences](/docs/graphql/overview#preferences)
...
## [GraphQL Playground](/docs/graphql/overview#graphql-playground)
...
To see more regarding how the above queries and mutations are used, visit your GraphQL playground (by default at [`${SERVER_URL}/api/graphql-playground`](http://localhost:3000/api/graphql-playground)) while your server is running. There, you can use the "Schema" and "Docs" buttons on the right to see a ton of detail about how GraphQL operates within Payload.

## [Custom Validation Rules](/docs/graphql/overview#custom-validation-rules)
...
## [Query complexity limits](/docs/graphql/overview#query-complexity-limits)
...
## [Field complexity](/docs/graphql/overview#field-complexity)
...
[Next Adding your own Queries and Mutations](/docs/graphql/extending)
