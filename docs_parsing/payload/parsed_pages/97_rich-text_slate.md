<a id="page-97"></a>
---
url: https://payloadcms.com/docs/rich-text/slate
---
...
## [Admin Options](/docs/rich-text/slate#admin-options)
...
### [TextAlign element](/docs/rich-text/slate#textalign-element)
...
### [Specifying which elements and leaves to allow](/docs/rich-text/slate#specifying-which-elements-and-leaves-to-allow)
...
### [Building custom elements and leaves](/docs/rich-text/slate#building-custom-elements-and-leaves)
...
### [Example](/docs/rich-text/slate#example)
```
import type { CollectionConfig } from 'payload'
...
### [Generating HTML](/docs/rich-text/slate#generating-html)
...
### [Built-in SlateJS Plugins](/docs/rich-text/slate#built-in-slatejs-plugins)
...
#### [`shouldBreakOutOnEnter`](/docs/rich-text/slate#shouldbreakoutonenter)
...
### [TypeScript](/docs/rich-text/slate#typescript)
...
[Next Live Preview](/docs/live-preview/overview)
