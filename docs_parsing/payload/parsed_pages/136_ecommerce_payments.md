<a id="page-136"></a>
---
url: https://payloadcms.com/docs/ecommerce/payments
---
...
## [REST API](/docs/ecommerce/payments#rest-api)
...
## [Stripe](/docs/ecommerce/payments#stripe)
...
### [Configuration](/docs/ecommerce/payments#configuration)
...
### [Stripe Webhooks](/docs/ecommerce/payments#stripe-webhooks)
...
### [Frontend usage](/docs/ecommerce/payments#frontend-usage)
...
## [Making your own Payment Adapter](/docs/ecommerce/payments#making-your-own-payment-adapter)
...
#### [initiatePayment](/docs/ecommerce/payments#initiatepayment)
...
#### [confirmOrder](/docs/ecommerce/payments#confirmorder)
...
#### [Payment Fields](/docs/ecommerce/payments#payment-fields)
...
### [Client side Payment Adapter](/docs/ecommerce/payments#client-side-payment-adapter)
...
## [Best Practices](/docs/ecommerce/payments#best-practices)
...
[Next Advanced uses and examples](/docs/ecommerce/advanced)
