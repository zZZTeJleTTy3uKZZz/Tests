...
## [Options](/docs/database/mongodb#options)
...
## [Access to Mongoose models](/docs/database/mongodb#access-to-mongoose-models)
...
## [Using other MongoDB implementations](/docs/database/mongodb#using-other-mongodb-implementations)
...
## [Using collation](/docs/database/mongodb#using-collation)
...
Collation will affect things like sort based on the locale being used. Please test thoroughly before using in production as it can affect your queries.

[Next Postgres](/docs/database/postgres)
