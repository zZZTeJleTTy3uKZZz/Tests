<a id="page-122"></a>
---
url: https://payloadcms.com/docs/plugins/build-your-own
---

# Building Your Own Plugin

Building your own [Payload Plugin](./overview) is easy, and if you're already familiar with Payload then you'll have everything you need to get started. You can either start from scratch or use the Plugin Template to get up and running quickly.
...
## [Plugins Recap](/docs/plugins/build-your-own#plugins-recap)
...
### [How to install a plugin](/docs/plugins/build-your-own#how-to-install-a-plugin)
...
### [Initialization](/docs/plugins/build-your-own#initialization)
...
## [Plugin Template](/docs/plugins/build-your-own#plugin-template)
...
### [The root folder](/docs/plugins/build-your-own#the-root-folder)
...
### [The dev folder](/docs/plugins/build-your-own#the-dev-folder)
...
## [Testing](/docs/plugins/build-your-own#testing)
...
## [Seeding data](/docs/plugins/build-your-own#seeding-data)
...
## [Building a Plugin](/docs/plugins/build-your-own#building-a-plugin)
...
### [Spread syntax](/docs/plugins/build-your-own#spread-syntax)
...
### [Extending functions](/docs/plugins/build-your-own#extending-functions)
...
## [Types](/docs/plugins/build-your-own#types)
...
## [Best practices](/docs/plugins/build-your-own#best-practices)

In addition to the setup covered above, here are other best practices to follow:

### [Providing an enable / disable option](/docs/plugins/build-your-own#providing-an-enable-disable-option)

For a better user experience, provide a way to disable the plugin without uninstalling it.

### [Include tests in your GitHub CI workflow](/docs/plugins/build-your-own#include-tests-in-your-github-ci-workflow)
...
### [Publish your finished plugin to npm](/docs/plugins/build-your-own#publish-your-finished-plugin-to-npm)
...
### [Add payload-plugin topic tag](/docs/plugins/build-your-own#add-payload-plugin-topic-tag)
...
### [Use Semantic Versioning (SemVer)](/docs/plugins/build-your-own#use-semantic-versioning-semver)
...
[Next Form Builder Plugin](/docs/plugins/form-builder)
