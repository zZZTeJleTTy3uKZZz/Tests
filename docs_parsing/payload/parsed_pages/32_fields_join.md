...
For the Join field to work, you must have an existing [relationship](./relationship) or [upload](./upload) field in the collection you are joining. This will reference the collection and path of the field of the related documents. To add a Relationship Field, set the `type` to `join` in your [Field Config](./overview):
```
...
### [Schema advice](/docs/fields/join#schema-advice)
...
### [Using the Join field to have full control of your database schema](/docs/fields/join#using-the-join-field-to-have-full-control-of-your-database-schema)
...
#### [Specifying additional fields on relationships](/docs/fields/join#specifying-additional-fields-on-relationships)
...
## [Config Options](/docs/fields/join#config-options)
...
## [ Admin Config Options](/docs/fields/join#admin-config-options)
...
## [Join Field Data](/docs/fields/join#join-field-data)
...
## [Join Field Data (polymorphic)](/docs/fields/join#join-field-data-polymorphic)
...
## [Query Options](/docs/fields/join#query-options)
...
### [Local API](/docs/fields/join#local-api)
...
### [Rest API](/docs/fields/join#rest-api)
...
### [GraphQL](/docs/fields/join#graphql)
...
[Next Row Field](/docs/fields/row)
