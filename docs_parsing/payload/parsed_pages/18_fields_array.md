...
## [Config Options](/docs/fields/array#config-options)
...
## [ Admin Options](/docs/fields/array#admin-options)
...
## [Example](/docs/fields/array#example)
...
## [Custom Components](/docs/fields/array#custom-components)### [Field](/docs/fields/array#field)#### [Server Component](/docs/fields/array#server-component)
```
...
#### [Client Component](/docs/fields/array#client-component)
```
'use client'
...
### [Label](/docs/fields/array#label)#### [Server Component](/docs/fields/array#server-component)
```
import React from 'react'
...
### [Row Label](/docs/fields/array#row-label)
```
'use client'
...
[Next Blocks Field](/docs/fields/blocks)
