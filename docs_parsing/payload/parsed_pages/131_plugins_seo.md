<a id="page-131"></a>
---
url: https://payloadcms.com/docs/plugins/seo
---
...
## [Installation](/docs/plugins/seo#installation)
...
## [Basic Usage](/docs/plugins/seo#basic-usage)
...
### [Options](/docs/plugins/seo#options)##### [`collections`](/docs/plugins/seo#collections)
...
##### [`globals`](/docs/plugins/seo#globals)
...
##### [`fields`](/docs/plugins/seo#fields)
...
##### [`uploadsCollection`](/docs/plugins/seo#uploadscollection)
...
##### [`tabbedUI`](/docs/plugins/seo#tabbedui)
...
##### [`generateTitle`](/docs/plugins/seo#generatetitle)
...
##### [`generateDescription`](/docs/plugins/seo#generatedescription)
...
##### [`generateImage`](/docs/plugins/seo#generateimage)
...
##### [`generateURL`](/docs/plugins/seo#generateurl)
...
#### [`interfaceName`](/docs/plugins/seo#interfacename)
...
## [Direct use of fields](/docs/plugins/seo#direct-use-of-fields)
...
## [TypeScript](/docs/plugins/seo#typescript)
...
## [Examples](/docs/plugins/seo#examples)
...
## [Screenshots](/docs/plugins/seo#screenshots)

![image](https://user-images.githubusercontent.com/70709113/163850633-f3da5f8e-2527-4688-bc79-17233307a883.png)

[Next Stripe Plugin](/docs/plugins/stripe)

#### Related Guides

  * [How to install and configure the Payload SEO plugin ](/posts/guides/how-to-install-and-configure-the-payload-seo-plugin-nextjs-app)
  * [Add schema markup to Payload + Next.js for better SEO ](/posts/guides/add-schema-markup-to-payload--nextjs-for-better-seo)
  * [How to build an SEO-friendly sitemap in Payload + Next.js ](/posts/guides/how-to-build-an-seo-friendly-sitemap-in-payload--nextjs)
  * [How to create a robots.txt file in Payload with Next.js ](/posts/guides/how-to-create-a-robotstxt-file-in-payload-with-nextjs)
