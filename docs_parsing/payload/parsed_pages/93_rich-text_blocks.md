<a id="page-93"></a>
---
url: https://payloadcms.com/docs/rich-text/blocks
---
...
## [Basic Setup](/docs/rich-text/blocks#basic-setup)

![lexical blocks example](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/lexical-blocks-light.jpg)
...
## [Blocks vs Inline Blocks](/docs/rich-text/blocks#blocks-vs-inline-blocks)

![Lexical blocks and inline blocks example](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/lexical-blocks-and-inline-blocks-example-1.jpg)

The `BlocksFeature` supports two types of blocks:

### [Blocks](/docs/rich-text/blocks#blocks)
...
### [Inline Blocks](/docs/rich-text/blocks#inline-blocks)
...
## [Data Structure](/docs/rich-text/blocks#data-structure)
...
## [Custom Block Components](/docs/rich-text/blocks#custom-block-components)
...
### [Block Components](/docs/rich-text/blocks#block-components)

![Lexical Block with custom Block component](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/custom-block.jpg)
...
![Lexical Block with custom Block component, not reusing the original block components](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/custom-block-2.jpg)
```
'use client'
    import type { LexicalBlockClientProps } from '@payloadcms/richtext-lexical'
...
### [Inline Block Components](/docs/rich-text/blocks#inline-block-components)

For inline blocks, similar composable primitives are available:

![Lexical Block with custom inline Block component](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/inline-block-custom-block-component.jpg)
```
'use client'
...
![Lexical Block with custom inline Block component, username tag example](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/inline-block-custom-block-component-2.jpg)
```
'use client'
    import type { LexicalInlineBlockClientProps } from '@payloadcms/richtext-lexical'
...
### [Label Components](/docs/rich-text/blocks#label-components)
...
![Block in Lexical field with custom label component](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/custom-block-label.jpg)
```
'use client'
...
![Inline Block in Lexical field with custom label component](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/custom-inline-block-label.jpg)
```
'use client'
...
### [Example: Pre-made CodeBlock](/docs/rich-text/blocks#example-pre-made-codeblock)
...
### [TypeScript](/docs/rich-text/blocks#typescript)
...
## [Rendering Blocks](/docs/rich-text/blocks#rendering-blocks)
...
## [Code Block](/docs/rich-text/blocks#code-block)

![Code Block in Lexical field](https://l4wlsi8vxy8hre4v.public.blob.vercel-storage.com/lexical-code-block.jpg)
...
### [CodeBlock Options](/docs/rich-text/blocks#codeblock-options)
...
### [TypeScript Support](/docs/rich-text/blocks#typescript-support)
...
[Next Custom Features](/docs/rich-text/custom-features)
