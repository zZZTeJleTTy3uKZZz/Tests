...
## [When To Use Context](/docs/hooks/context#when-to-use-context)
...
## [How To Use Context](/docs/hooks/context#how-to-use-context)

Let's see examples on how context can be used in the first two scenarios mentioned above:

### [Passing Data Between Hooks](/docs/hooks/context#passing-data-between-hooks)
...
### [Preventing Infinite Loops](/docs/hooks/context#preventing-infinite-loops)
...
## [TypeScript](/docs/hooks/context#typescript)
...
[Next Local API](/docs/local-api/overview)
