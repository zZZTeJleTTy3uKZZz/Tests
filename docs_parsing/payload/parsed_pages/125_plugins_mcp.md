...
This plugin is currently in Beta and may have breaking changes in future releases.

This plugin adds [Model Context Protocol](https://modelcontextprotocol.io/docs/getting-started/intro) capabilities.

This plugin is completely open-source and the [source code can be found here](https://github.com/payloadcms/payload/tree/main/packages/plugin-mcp). If you need help, check out our [Community Help](/community-help). If you think you've found a bug, please [open a new issue](https://github.com/payloadcms/payload/issues/new?assignees=&labels=plugin%3A%mcp&template=bug_report.md&title=plugin-mcp%3A) with as much detail as possible.

## [Core features](/docs/plugins/mcp#core-features)
...
## [Installation](/docs/plugins/mcp#installation)
...
## [Basic Usage](/docs/plugins/mcp#basic-usage)
...
### [Options](/docs/plugins/mcp#options)
...
## [Connecting to MCP Clients](/docs/plugins/mcp#connecting-to-mcp-clients)

After installing and configuring the plugin, you can connect apps with MCP client capabilities to Payload.

### [Step 1: Create an API Key](/docs/plugins/mcp#step-1-create-an-api-key)
...
### [Step 2: Configure Your MCP Client](/docs/plugins/mcp#step-2-configure-your-mcp-client)
...
#### [[VSCode](https://code.visualstudio.com/docs/copilot/customization/mcp-servers)](/docs/plugins/mcp#)
```
{
      "mcp.servers": {
        "Payload": {
...
#### [[Cursor](https://cursor.com/docs/context/mcp)](/docs/plugins/mcp#)
```
{
      "mcpServers": {
        "Payload": {
...
#### [Other MCP Clients](/docs/plugins/mcp#other-mcp-clients)
...
## [Customizations](/docs/plugins/mcp#customizations)
...
## [Prompts](/docs/plugins/mcp#prompts)
...
## [Resources](/docs/plugins/mcp#resources)
...
## [API Key access to MCP](/docs/plugins/mcp#api-key-access-to-mcp)
...
## [Performance](/docs/plugins/mcp#performance)
...
[Next Multi-Tenant Plugin](/docs/plugins/multi-tenant)
