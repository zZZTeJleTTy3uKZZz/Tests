...
## [Dependency mismatches](/docs/troubleshooting/troubleshooting#dependency-mismatches)
...
### [Confirm whether duplicates exist](/docs/troubleshooting/troubleshooting#confirm-whether-duplicates-exist)
...
This prints the dependency tree and shows which versions are being installed. If you see more than one distinct version—or the same version listed under different paths—you have duplication.
  ...
  1. Manual check (works with any package manager)
...
#### [If no duplicates are found](/docs/troubleshooting/troubleshooting#if-no-duplicates-are-found)
...
### [Fixing dependency issues](/docs/troubleshooting/troubleshooting#fixing-dependency-issues)
...
#### [If the error persists](/docs/troubleshooting/troubleshooting#if-the-error-persists)
...
If you are using a version control system, make sure to commit your lockfile after this step.
  ...
  1. Deduplicate anything that slipped through
...
### [Monorepos](/docs/troubleshooting/troubleshooting#monorepos)
...
## ["Unauthorized, you must be logged in to make this request" when attempting to log in](/docs/troubleshooting/troubleshooting#unauthorized-you-must-be-logged-in-to-make-this-request-when-attempting-to-log-in)
...
## [Using --experimental-https](/docs/troubleshooting/troubleshooting#using-experimental-https)
...
## [Database password encoding issues](/docs/troubleshooting/troubleshooting#database-password-encoding-issues)
...
[Next TypeScript - Overview](/docs/typescript/overview)
