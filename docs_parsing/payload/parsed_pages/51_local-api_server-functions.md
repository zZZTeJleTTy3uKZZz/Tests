<a id="page-51"></a>
---
url: https://payloadcms.com/docs/local-api/server-functions
---
...
### [Why Use Server Functions?](/docs/local-api/server-functions#why-use-server-functions)
...
### [When to Use Server Functions](/docs/local-api/server-functions#when-to-use-server-functions)
...
## [Examples](/docs/local-api/server-functions#examples)
...
### [Creating a Document](/docs/local-api/server-functions#creating-a-document)
...
### [Updating a Document](/docs/local-api/server-functions#updating-a-document)
...
### [Authenticating a User](/docs/local-api/server-functions#authenticating-a-user)
...
### [Creating a Document with File Upload](/docs/local-api/server-functions#creating-a-document-with-file-upload)
...
## [Reusable Payload Server Functions](/docs/local-api/server-functions#reusable-payload-server-functions)
...
### [Login](/docs/local-api/server-functions#login)
...
#### [Importing the `login` function](/docs/local-api/server-functions#importing-the-login-function)
```
...
#### [Login from the React Client Component](/docs/local-api/server-functions#login-from-the-react-client-component)
```
'use client'
...
### [Logout](/docs/local-api/server-functions#logout)

Logs out the current user by clearing the authentication cookie and current sessions.

#### [Importing the `logout` function](/docs/local-api/server-functions#importing-the-logout-function)
```
...
#### [Logout from the React Client Component](/docs/local-api/server-functions#logout-from-the-react-client-component)
```
'use client'
...
### [Refresh](/docs/local-api/server-functions#refresh)

Refreshes the authentication token and current session for the logged-in user.

#### [Importing the `refresh` function](/docs/local-api/server-functions#importing-the-refresh-function)
```
...
#### [Using Refresh from the React Client Component](/docs/local-api/server-functions#using-refresh-from-the-react-client-component)
```
'use client'
...
## [Error Handling in Server Functions](/docs/local-api/server-functions#error-handling-in-server-functions)
...
### [Best Practices](/docs/local-api/server-functions#error-handling-best-practices)
...
## [Security Considerations](/docs/local-api/server-functions#security-considerations)
...
### [Best Practices](/docs/local-api/server-functions#security-best-practices)
...
[Next Respecting Access Control with Local API Operations](/docs/local-api/access-control)
