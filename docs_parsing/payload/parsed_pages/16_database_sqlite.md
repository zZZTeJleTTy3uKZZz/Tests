<a id="page-16"></a>
---
url: https://payloadcms.com/docs/database/sqlite
---
...
## [Options](/docs/database/sqlite#options)
...
`wal` |  Enable Write-Ahead Logging (WAL) mode for improved performance and concurrency. More Details  
  
## [Access to Drizzle](/docs/database/sqlite#access-to-drizzle)
...
## [Tables and relations](/docs/database/sqlite#tables-and-relations)
...
## [Prototyping in development mode](/docs/database/sqlite#prototyping-in-development-mode)
...
## [Migration workflows](/docs/database/sqlite#migration-workflows)
...
## [Drizzle schema hooks](/docs/database/sqlite#drizzle-schema-hooks)### [beforeSchemaInit](/docs/database/sqlite#beforeschemainit)
...
### [afterSchemaInit](/docs/database/sqlite#afterschemainit)
...
### [Note for generated schema:](/docs/database/sqlite#note-for-generated-schema)
...
## [D1 Database](/docs/database/sqlite#d1-database)

This adapter is currently in beta as it is new and could be subject to changes which may be considered breaking
...
### [D1 Read Replicas](/docs/database/sqlite#d1-read-replicas)
...
### [WAL Mode](/docs/database/sqlite#wal-mode)
...
```
title="Example SQLite Adapter with WAL"
    import { sqliteAdapter } from '@payloadcms/db-sqlite'
    export default buildConfig({
      // Your config goes here
      collections: [
...
[Next Fields Overview](/docs/fields/overview)
