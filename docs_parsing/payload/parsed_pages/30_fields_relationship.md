...
## [Config Options](/docs/fields/relationship#config-options)
...
## [Admin Options](/docs/fields/relationship#admin-options)
...
### [Sort Options](/docs/fields/relationship#sort-options)
...
## [Filtering relationship options](/docs/fields/relationship#filtering-relationship-options)
...
## [Example](/docs/fields/relationship#example)
```
...
## [Bi-directional relationships](/docs/fields/relationship#bi-directional-relationships)
...
## [How the data is saved](/docs/fields/relationship#how-the-data-is-saved)
...
### [Has One](/docs/fields/relationship#has-one)
...
### [Has One - Polymorphic](/docs/fields/relationship#has-one-polymorphic)
...
### [Has Many](/docs/fields/relationship#has-many)
...
### [Has Many - Polymorphic](/docs/fields/relationship#has-many-polymorphic)
```
{
      slug: 'example-collection',
      fields: [
...
### [Querying and Filtering Polymorphic Relationships](/docs/fields/relationship#querying-and-filtering-polymorphic-relationships)
...
## [Custom Components](/docs/fields/relationship#custom-components)### [Field](/docs/fields/relationship#field)#### [Server Component](/docs/fields/relationship#server-component)
```
...
#### [Client Component](/docs/fields/relationship#client-component)
```
'use client'
...
### [Label](/docs/fields/relationship#label)#### [Server Component](/docs/fields/relationship#server-component)
```
import React from 'react'
...
[Next Rich Text Field](/docs/fields/rich-text)

#### Community Help Threads

  * [Nested media is only showing image ids array. ](/community-help/discord/nested-media-is-only-showing-image-ids-array)
  * [Have relationship field show a different field from the related entity rather than ID ](/community-help/discord/have-relationship-field-show-a-different-field-from-the-related-entity-rather-than-id)
  * [Querying Multi-Collection Relationship Field Error ](/community-help/discord/querying-multi-collection-relationship-field-error)
