...
## [ Config Options](/docs/authentication/overview#config-options)
...
**Note:** Auth-enabled Collections will be automatically injected with the `hash`, `salt`, and `email` fields. [More details](../fields/overview#field-names).
...
### [Login With Username](/docs/authentication/overview#login-with-username)
...
## [Auto-Login](/docs/authentication/overview#auto-login)
...
## [Auto-Refresh](/docs/authentication/overview#auto-refresh)
...
## [Operations](/docs/authentication/overview#operations)
...
## [Strategies](/docs/authentication/overview#strategies)
...
### [HTTP-Only Cookies](/docs/authentication/overview#http-only-cookies)
...
### [JSON Web Tokens](/docs/authentication/overview#json-web-tokens)
...
### [API Keys](/docs/authentication/overview#api-keys)
...
### [Custom Strategies](/docs/authentication/overview#custom-strategies)
...
### [Access Control](/docs/authentication/overview#access-control)
...
[Next Authentication Operations](/docs/authentication/operations)
