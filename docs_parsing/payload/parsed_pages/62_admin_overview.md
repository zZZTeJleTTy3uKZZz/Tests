...
## [Project Structure](/docs/admin/overview#project-structure)
...
The `admin` directory contains all the _pages_ related to the interface itself, whereas the `api` and `graphql` directories contain all the _routes_ related to the [REST API](../rest-api/overview) and [GraphQL API](../graphql/overview). All admin routes are easily configurable to meet your application's exact requirements.
...
## [Admin Options](/docs/admin/overview#admin-options)
...
### [The Admin User Collection](/docs/admin/overview#the-admin-user-collection)
...
### [Role-based Access Control](/docs/admin/overview#role-based-access-control)
...
## [Customizing Routes](/docs/admin/overview#customizing-routes)

You have full control over the routes that Payload binds itself to. This includes both Root-level Routes such as the [REST API](../rest-api/overview), and Admin-level Routes such as the user's account page. You can customize these routes to meet the needs of your application simply by specifying the desired paths in your config.

### [Root-level Routes](/docs/admin/overview#root-level-routes)
...
**Important:** Changing Root-level Routes also requires a change to Project Structure to match the new route. More details.

**Tip:** You can easily add _new_ routes to the Admin Panel through [Custom Endpoints](../rest-api/overview#custom-endpoints) and [Custom Views](../custom-components/custom-views).

#### [Customizing Root-level Routes](/docs/admin/overview#customizing-root-level-routes)
...
**Note:** If you set Root-level Routes _before_ auto-generating the Admin Panel via `create-payload-app`, your Project Structure will already be set up correctly.

### [Admin-level Routes](/docs/admin/overview#admin-level-routes)
...
## [Light and Dark Modes](/docs/admin/overview#light-and-dark-modes)
...
## [Timezones](/docs/admin/overview#timezones)
...
### [Extending supported timezones](/docs/admin/overview#extending-supported-timezones)
...
### [Using a UTC timezone](/docs/admin/overview#using-a-utc-timezone)
...
## [Toast](/docs/admin/overview#toast)
...
[Next Preview](/docs/admin/preview)
