...
### [Automatic browser inclusion](/docs/authentication/cookies#automatic-browser-inclusion)
...
### [HTTP Authentication](/docs/authentication/cookies#http-authentication)
...
### [CSRF Attacks](/docs/authentication/cookies#csrf-attacks)
...
### [CSRF Prevention](/docs/authentication/cookies#csrf-prevention)
...
#### [Cross domain authentication](/docs/authentication/cookies#cross-domain-authentication)
...
##### [1\. Use subdomains](/docs/authentication/cookies#1-use-subdomains)
...
##### [2\. Configure cookies](/docs/authentication/cookies#2-configure-cookies)
...
[Next API Key Strategy](/docs/authentication/api-keys)
