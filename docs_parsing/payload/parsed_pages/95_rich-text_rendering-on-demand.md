<a id="page-95"></a>
---
url: https://payloadcms.com/docs/rich-text/rendering-on-demand
---
...
## [Inside an existing Form](/docs/rich-text/rendering-on-demand#inside-an-existing-form)
...
## [Outside of a Form (you control state)](/docs/rich-text/rendering-on-demand#outside-of-a-form-you-control-state)
```
'use client'
...
## [Choosing the schemaPath](/docs/rich-text/rendering-on-demand#choosing-the-schemapath)
...
[Next Lexical Migration](/docs/rich-text/migration)
