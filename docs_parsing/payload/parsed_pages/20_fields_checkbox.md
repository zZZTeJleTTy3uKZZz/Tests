...
![Checkbox field with text field in Payload Admin Panel](https://payloadcms.com/images/docs/fields/checkbox.png)
...
## [Config Options](/docs/fields/checkbox#config-options)
...
## [ Example](/docs/fields/checkbox#example)
...
## [Custom Components](/docs/fields/checkbox#custom-components)### [Field](/docs/fields/checkbox#field)#### [Server Component](/docs/fields/checkbox#server-component)
```
...
#### [Client Component](/docs/fields/checkbox#client-component)
```
'use client'
...
### [Label](/docs/fields/checkbox#label)#### [Server Component](/docs/fields/checkbox#server-component)
```
import React from 'react'
...
[Next JSON Field](/docs/fields/json)
