...
## [Config Options](/docs/hooks/fields#config-options)
...
### [beforeValidate](/docs/hooks/fields#beforevalidate)
...
### [beforeChange](/docs/hooks/fields#beforechange)
...
### [afterChange](/docs/hooks/fields#afterchange)
...
### [afterRead](/docs/hooks/fields#afterread)
...
### [beforeDuplicate](/docs/hooks/fields#beforeduplicate)
...
## [TypeScript](/docs/hooks/fields#typescript)
...
### [Practical Example with Generated Types](/docs/hooks/fields#practical-example-with-generated-types)
...
**Tip:** When defining field hooks, use the three generic parameters for full type safety: document type, field value type, and sibling data type. This provides autocomplete and type checking for all hook arguments.

[Next Context](/docs/hooks/context)
