...
## [Defining Custom Components](/docs/custom-components/overview#defining-custom-components)
...
### [Component Paths](/docs/custom-components/overview#component-paths)
...
### [Component Config](/docs/custom-components/overview#component-config)
...
### [Import Map](/docs/custom-components/overview#import-map)
...
#### [Overriding Import Map Location](/docs/custom-components/overview#overriding-import-map-location)
...
#### [Custom Imports](/docs/custom-components/overview#custom-imports)
...
## [Building Custom Components](/docs/custom-components/overview#building-custom-components)
...
### [Default Props](/docs/custom-components/overview#default-props)
...
### [Client Components](/docs/custom-components/overview#client-components)
...
### [Accessing the Payload Config](/docs/custom-components/overview#accessing-the-payload-config)
...
### [Getting the Current Language](/docs/custom-components/overview#getting-the-current-language)
...
### [Getting the Current Locale](/docs/custom-components/overview#getting-the-current-locale)
...
### [Using Hooks](/docs/custom-components/overview#using-hooks)

To make it easier to build your Custom Components, you can use [Payload's built-in React Hooks](../admin/react-hooks) in any Client Component. For example, you might want to interact with one of Payload's many React Contexts. To do this, you can use one of the many hooks available depending on your needs.
```
'use client'
    import React from 'react'
...
### [Adding Styles](/docs/custom-components/overview#adding-styles)
...
**Note:** You can also drill into Payload's own component styles, or easily apply global, app-wide CSS. More on that [here](../admin/customizing-css).

## [Performance](/docs/custom-components/overview#performance)
...
### [Follow React and Next.js best practices](/docs/custom-components/overview#follow-react-and-nextjs-best-practices)
...
### [Reducing initial HTML size](/docs/custom-components/overview#reducing-initial-html-size)
...
**Tip:** Use [React Suspense](https://react.dev/reference/react/Suspense) to progressively load components and improve perceived performance.

### [Prevent unnecessary re-renders](/docs/custom-components/overview#prevent-unnecessary-re-renders)
...
### [Imports best practices](/docs/custom-components/overview#imports-best-practices)
...
See the [Performance](../performance/overview) documentation for more tips and best practices.

### [Troubleshooting](/docs/custom-components/overview#troubleshooting)#### ['Assignment cannot be destructured' or 'value ... of useConfig is undefined'](/docs/custom-components/overview#assignment-cannot-be-destructured-or-value-of-useconfig-is-undefined)
...
[Next Root Components](/docs/custom-components/root-components)
