...
## [Software Requirements](/docs/getting-started/installation#software-requirements)
...
## [Quickstart with create-payload-app](/docs/getting-started/installation#quickstart-with-create-payload-app)
...
## [Adding to an existing app](/docs/getting-started/installation#adding-to-an-existing-app)
...
#### [1\. Install the relevant packages](/docs/getting-started/installation#1-install-the-relevant-packages)
...
You'll also likely want to install the following optional packages:
  ...
  * `sharp` \- Image resizing, cropping, and focal point support (only needed if you use [Upload](../upload/overview) collections with image manipulation)
  * `graphql` \- Only needed if you want to use the [GraphQL API](../graphql/overview)
...
**Note:** New [Database Adapters](../database/overview) are becoming available every day. Check the docs for the most up-to-date list of what's available.

#### [2\. Copy Payload files into your Next.js app folder](/docs/getting-started/installation#2-copy-payload-files-into-your-nextjs-app-folder)
...
```
 ...
 _For an exact reference of the_` _(payload)_`_directory, see_[ _Project Structure_](../admin/overview#project-structure) _._
...
#### [3\. Add the Payload Plugin to your Next.js config](/docs/getting-started/installation#3-add-the-payload-plugin-to-your-nextjs-config)
...
#### [4\. Create a Payload Config and add it to your TypeScript config](/docs/getting-started/installation#4-create-a-payload-config-and-add-it-to-your-typescript-config)
...
#### [5\. Fire it up!](/docs/getting-started/installation#5-fire-it-up)
...
[Next The Payload Config](/docs/configuration/overview)
