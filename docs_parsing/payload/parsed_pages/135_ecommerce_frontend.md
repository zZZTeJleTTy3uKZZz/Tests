<a id="page-135"></a>
---
url: https://payloadcms.com/docs/ecommerce/frontend
---
...
### [EcommerceProvider](/docs/ecommerce/frontend#ecommerceprovider)
...
`api` |  `object` |  API configuration for the internal fetches of the provider. More  
...
#### [api](/docs/ecommerce/frontend#api)
...
#### [cartsFetchQuery](/docs/ecommerce/frontend#cartsfetchquery)
...
#### [syncLocalStorage](/docs/ecommerce/frontend#synclocalstorage)
...
### [useCart](/docs/ecommerce/frontend#usecart)
...
### [useAddresses](/docs/ecommerce/frontend#useaddresses)
...
### [usePayments](/docs/ecommerce/frontend#usepayments)
...
Property |  Type |  Description   
---|---|---  
`confirmOrder` |  `(args) => Promise<Order>` |  Method to confirm an order by ID. More  
`initiatePayment` |  `(args) => Promise<void>` |  Method to initiate a payment for an order. More  
...
#### [confirmOrder](/docs/ecommerce/frontend#confirmorder)
...
This will mark the transaction as complete in the backend and create the order for the user.

#### [initiatePayment](/docs/ecommerce/frontend#initiatepayment)
...
At this step the cart is verified and a transaction is created in the backend with the address details provided. No order is created yet until you call `confirmOrder`, which should be done after payment is confirmed on the client side or via webhooks if you opt for that approach instead.

### [useCurrency](/docs/ecommerce/frontend#usecurrency)
...
Property |  Type |  Description   
---|---|---  
`currenciesConfig` |  `CurrenciesConfig` |  The configuration for supported currencies. Directly matching the config provided to the Context Provider. More  
...
### [useEcommerceConfig](/docs/ecommerce/frontend#useecommerceconfig)
...
### [useEcommerce](/docs/ecommerce/frontend#useecommerce)
...
## [Hooks](/docs/ecommerce/frontend#hooks)
...
### [onLogin](/docs/ecommerce/frontend#onlogin)
...
### [onLogout](/docs/ecommerce/frontend#onlogout)
...
### [clearSession](/docs/ecommerce/frontend#clearsession)
...
### [mergeCart](/docs/ecommerce/frontend#mergecart)
...
### [refreshCart](/docs/ecommerce/frontend#refreshcart)
...
## [Session Management](/docs/ecommerce/frontend#session-management)
...
### [Handling Login](/docs/ecommerce/frontend#handling-login)
...
### [Handling Logout](/docs/ecommerce/frontend#handling-logout)
...
[Next Payment Adapters](/docs/ecommerce/payments)
