...
### [Instant backend superpowers](/docs/getting-started/what-is-payload#instant-backend-superpowers)
...
### [Open source - deploy anywhere, including Vercel](/docs/getting-started/what-is-payload#open-source-deploy-anywhere-including-vercel)
...
### [Code-first and version controlled](/docs/getting-started/what-is-payload#code-first-and-version-controlled)
...
### [Fully extensible](/docs/getting-started/what-is-payload#fully-extensible)
...
## [Use Cases](/docs/getting-started/what-is-payload#use-cases)
...
### [Headless CMS](/docs/getting-started/what-is-payload#headless-cms)
...
### [Enterprise Tool](/docs/getting-started/what-is-payload#enterprise-tool)
...
### [Headless Commerce](/docs/getting-started/what-is-payload#headless-commerce)
...
### [Digital Asset Management](/docs/getting-started/what-is-payload#digital-asset-management)
...
[Click here](/use-cases/digital-asset-management) for more information on how to get started with Payload as a DAM.

## [Choosing a Framework](/docs/getting-started/what-is-payload#choosing-a-framework)
...
### [When Payload might be for you](/docs/getting-started/what-is-payload#when-payload-might-be-for-you)
...
### [When Payload might not be for you](/docs/getting-started/what-is-payload#when-payload-might-not-be-for-you)
...
[Next Payload Concepts](/docs/getting-started/concepts)
