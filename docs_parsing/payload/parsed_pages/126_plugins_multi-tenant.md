...
## [Installation](/docs/plugins/multi-tenant#installation)
...
### [Options](/docs/plugins/multi-tenant#options)
...
## [Basic Usage](/docs/plugins/multi-tenant#basic-usage)
...
## [Front end usage](/docs/plugins/multi-tenant#front-end-usage)
...
### [NextJS rewrites](/docs/plugins/multi-tenant#nextjs-rewrites)
...
### [React Hooks](/docs/plugins/multi-tenant#react-hooks)

Below are the hooks exported from the plugin that you can import into your own custom components to consume.

#### [useTenantSelection](/docs/plugins/multi-tenant#usetenantselection)
...
## [Examples](/docs/plugins/multi-tenant#examples)
...
[Next Nested Docs Plugin](/docs/plugins/nested-docs)
