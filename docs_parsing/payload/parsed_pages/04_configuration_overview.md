...
## [Config Options](/docs/configuration/overview#config-options)
...
**Note:** Some properties are removed from the client-side bundle. [More details](../custom-components/overview#accessing-the-payload-config).

### [TypeScript Config](/docs/configuration/overview#typescript-config)
...
## [Config Location](/docs/configuration/overview#config-location)
...
### [Customizing the Config Location](/docs/configuration/overview#customizing-the-config-location)
...
## [Telemetry](/docs/configuration/overview#telemetry)
...
## [Cross-origin resource sharing (CORS)](/docs/configuration/overview#cors)
...
## [TypeScript](/docs/configuration/overview#typescript)
...
## [Server vs. Client](/docs/configuration/overview#server-vs-client)
...
## [Compatibility flags](/docs/configuration/overview#compatibility-flags)
...
## [Custom bin scripts](/docs/configuration/overview#custom-bin-scripts)
...
## [Running bin scripts on a schedule](/docs/configuration/overview#running-bin-scripts-on-a-schedule)
...
[Next Collection Configs](/docs/configuration/collections)
