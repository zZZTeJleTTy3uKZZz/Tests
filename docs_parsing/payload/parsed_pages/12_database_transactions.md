...
## [Async Hooks with Transactions](/docs/database/transactions#async-hooks-with-transactions)
...
## [Direct Transaction Access](/docs/database/transactions#direct-transaction-access)
...
## [Disabling Transactions](/docs/database/transactions#disabling-transactions)
...
[Next Indexes](/docs/database/indexes)
