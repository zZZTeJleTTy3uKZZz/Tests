...
## [React](/docs/live-preview/server#react)
...
## [Building your own router refresh component](/docs/live-preview/server#building-your-own-router-refresh-component)
...
## [Example](/docs/live-preview/server#example)
...
## [Troubleshooting](/docs/live-preview/server#troubleshooting)#### [Updates do not appear as fast as client-side Live Preview](/docs/live-preview/server#updates-do-not-appear-as-fast-as-client-side-live-preview)
...
#### [Iframe refuses to connect](/docs/live-preview/server#iframe-refuses-to-connect)
...
[Next Client-side Live Preview](/docs/live-preview/client)
