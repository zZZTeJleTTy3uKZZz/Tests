...
## [Accessing Payload](/docs/local-api/overview#accessing-payload)

You can gain access to the currently running `payload` object via two ways:

#### [Accessing from args or `req`](/docs/local-api/overview#accessing-from-args-or-req)
...
#### [Importing it](/docs/local-api/overview#importing-it)
...
## [Local options available](/docs/local-api/overview#local-options-available)
...
## [ Transactions](/docs/local-api/overview#transactions)
...
## [Collections](/docs/local-api/overview#collections)

The following Collection operations are available through the Local API:

### [Create](/docs/local-api/overview#collection-create)
```
...
### [Find](/docs/local-api/overview#collection-find)
```
...
`pagination`, `page`, and `limit` are three related properties [documented here](../queries/pagination).

### [Find by ID](/docs/local-api/overview#collection-find-by-id)
```
...
### [Count](/docs/local-api/overview#collection-count)
```
...
### [FindDistinct](/docs/local-api/overview#collection-find-distinct)
```
// Result will be an object with:
    // {
...
### [Update by ID](/docs/local-api/overview#collection-update-by-id)
```
...
### [Update Many](/docs/local-api/overview#collection-update-many)
```
// Result will be an object with:
    // {
...
### [Delete](/docs/local-api/overview#collection-delete)
```
...
### [Delete Many](/docs/local-api/overview#collection-delete-many)
```
// Result will be an object with:
    // {
...
## [Auth Operations](/docs/local-api/overview#auth-operations)

If a collection has [`Authentication`](../authentication/overview) enabled, additional Local API operations will be available:

### [Auth](/docs/local-api/overview#auth)
```
...
### [Login](/docs/local-api/overview#login)
```
// result will be formatted as follows:
    // {
...
### [Forgot Password](/docs/local-api/overview#forgot-password)
```
...
### [Reset Password](/docs/local-api/overview#reset-password)
```
// Result will be formatted as follows:
    // {
    //   token: 'o38jf0q34jfij43f3f...', // JWT used for auth
...
### [Unlock](/docs/local-api/overview#unlock)
```
...
### [Verify](/docs/local-api/overview#verify)
```
// Returned result will be a boolean representing success or failure
...
## [Globals](/docs/local-api/overview#globals)

The following Global operations are available through the Local API:

### [Find](/docs/local-api/overview#global-find)
```
...
### [Update](/docs/local-api/overview#global-update)
```
...
## [TypeScript](/docs/local-api/overview#typescript)
...
[Next Using Payload outside Next.js](/docs/local-api/outside-nextjs)

#### Related Guides

  * [Exploring Payload Local API: Faster queries for Next.js & beyond ](/posts/guides/payload-local-api-faster-queries-for-nextjs-and-beyond)
