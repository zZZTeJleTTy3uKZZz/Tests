...
## [Root Metadata](/docs/admin/metadata#root-metadata)
...
### [Icons](/docs/admin/metadata#icons)
...
### [Open Graph](/docs/admin/metadata#open-graph)
...
### [Robots](/docs/admin/metadata#robots)
...
##### [Prevent Crawling](/docs/admin/metadata#prevent-crawling)
...
## [Collection Metadata](/docs/admin/metadata#collection-metadata)
...
## [Global Metadata](/docs/admin/metadata#global-metadata)
...
## [View Metadata](/docs/admin/metadata#view-metadata)

View Metadata is the metadata that is applied to specific [Views](../custom-components/custom-views) within the Admin Panel. This metadata is used to customize the title and description of a specific view, overriding any metadata set at the Root, Collection, or Global level.
...
[Next Swap in your own React components](/docs/custom-components/overview)
