<a id="page-13"></a>
---
url: https://payloadcms.com/docs/database/indexes
---
...
**Tip:** If you're using MongoDB, you can use [MongoDB Compass](https://www.mongodb.com/products/compass) to visualize and manage your indexes.

## [Compound Indexes](/docs/database/indexes#compound-indexes)
...
## [Localized fields and MongoDB indexes](/docs/database/indexes#localized-fields-and-mongodb-indexes)
...
[Next MongoDB](/docs/database/mongodb)
