...
### [Link ComponentEnable fast client-side navigation with the built-in `next/link` component.](/docs/app/api-reference/components/link)### [loading.jsAPI reference for the loading.js file.](/docs/app/api-reference/file-conventions/loading)### [PrefetchingLearn how to configure prefetching in Next.js](/docs/app/guides/prefetching)
