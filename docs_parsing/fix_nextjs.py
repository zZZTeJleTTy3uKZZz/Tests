...
old_sem = """        print(f"Запускаем парсинг {len(links_to_parse)} страниц...")
        semaphore = asyncio.Semaphore(100)  # Полностью асинхронное скачивание"""
...
old_sem2 = """        print(f"Запускаем парсинг {len(links_to_parse)} страниц...")
        semaphore = asyncio.Semaphore(5)"""

text = text.replace(old_sem2, new_sem)
