...
[Guides](/docs/pages/guides)[Migrating](/docs/pages/guides/migrating)App Router
...
**Step 2: Create a new page**
  ...
  * If you were fetching data in `pages/index.js`, move the data fetching logic directly into the Server Component using the new [data fetching APIs](/docs/app/getting-started/fetching-data). See the data fetching upgrade guide for more details.
