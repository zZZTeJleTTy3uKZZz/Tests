...
### [generateSitemapsLearn how to use the generateSiteMaps function to create multiple sitemaps for your application.](/docs/app/api-reference/functions/generate-sitemaps)
