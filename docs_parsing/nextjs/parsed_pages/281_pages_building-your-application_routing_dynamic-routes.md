...
### [Linking and NavigatingLearn how navigation works in Next.js, and how to use the Link Component and `useRouter` hook.](/docs/pages/building-your-application/routing/linking-and-navigating)### [useRouterLearn more about the API of the Next.js Router, and access the router instance in your page with the useRouter hook.](/docs/pages/api-reference/functions/use-router)
