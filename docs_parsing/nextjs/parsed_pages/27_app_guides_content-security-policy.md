...
### [proxy.jsAPI reference for the proxy.js file.](/docs/app/api-reference/file-conventions/proxy)### [headersAPI reference for the headers function.](/docs/app/api-reference/functions/headers)
