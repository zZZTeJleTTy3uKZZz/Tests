...
### [proxy.jsAPI reference for the proxy.js file.](/docs/app/api-reference/file-conventions/proxy)### [Backend for FrontendLearn how to use Next.js as a backend framework](/docs/app/guides/backend-for-frontend)
