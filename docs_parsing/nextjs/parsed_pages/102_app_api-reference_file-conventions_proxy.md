...
> 
> To pass information from Proxy to your application, use headers, cookies, [rewrites](/docs/app/api-reference/functions/next-response#rewrite), [redirects](/docs/app/api-reference/functions/next-response#redirect), or the URL.
...
### [NextRequestAPI Reference for NextRequest.](/docs/app/api-reference/functions/next-request)### [NextResponseAPI Reference for NextResponse.](/docs/app/api-reference/functions/next-response)
