...
[Pages Router](/docs/pages)[Guides](/docs/pages/guides)Internationalization
...
> **Good to know** : These limits have been added initially to prevent potential performance issues at build time. You can workaround these limits with custom routing using [Proxy](/docs/pages/api-reference/file-conventions/proxy) in Next.js 12.
